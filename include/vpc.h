...
namespace vpc {
    ...
    enum: byte {
        ...
        CPU_LDG, // LOAD VALUE INTO REGISTER_GENERAL1

        CPU_STA, // STORE VALUE FROM REGISTER_A TO ADDR
        CPU_STG, // STORE FROM VALUE REGISTER_GERNERAL1 TO ADDR
        ...
        CPU_MUL, // MUL A AND B THEN OUTPUT TO REGISTER_A
        CPU_DIV, // DIV A AND B THEN OUTPUT TO REGISTER_A
        CPU_NEG, // NEG A THEN OUTPUT TO REGISTER_A

        CPU_LSH, // SHIFT BY ARG BITS TO THE LEFT
        CPU_RSH, // SHIFT BY ARG BITS TO THE RIGHT
        ...
        CPU_NUL, // ZERO OUT A VALUE IN MEMORY
